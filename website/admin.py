...
class NewsAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'id', 'description', 'location', 'createdAtDate', 'createdAtTime']
admin.site.register(News, NewsAdmin)

class EventAdmin(admin.ModelAdmin):
    fields = ('user', 'title', 'description', 'dateStart', 'dateEnd', 'timeStart', 'timeEnd', 'location')
    list_display = ['title', 'id', 'description', 'dateStart', 'dateEnd', 'timeStart', 'timeEnd', 'location']
admin.site.register(Event, EventAdmin)

class MarkerAdmin(admin.ModelAdmin):
    fields = ('title', 'type', 'typeId', 'latitude', 'longitude', 'content', 'users')
    list_display = ['title', 'id', 'type', 'typeId', 'latitude', 'longitude', 'content']
admin.site.register(Marker, MarkerAdmin)

class JobAdmin(admin.ModelAdmin):
    fields = ('userId', 'title', 'description', 'location')
    list_display = ['userId', 'id', 'title', 'description', 'location']
